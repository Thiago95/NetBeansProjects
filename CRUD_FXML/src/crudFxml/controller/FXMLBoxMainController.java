...
public class FXMLBoxMainController implements Initializable {
    ...
    public void mnplcMenuItemCadastrosClientes() throws IOException{
        try{
            AnchorPane a = (AnchorPane) FXMLLoader.load(getClass().getResource("/crudFxml/view/FXMLAlterarCliente.fxml"));
    ...
    public void mnplcMenuItemCadastrosVendas() throws IOException{
        try{
            AnchorPane a = (AnchorPane) FXMLLoader.load(getClass().getResource("/crudFxml/view/FXMLAlterarVenda.fxml"));
            anchorPane.getChildren().setAll(a);
        }catch(LoadException e){
            System.out.println("erro: " + e);
        }
